...
/**
 * @Description: 词条点赞收藏控制器
 * Created by Colin on 2020/3/22 0022 下午 5:48.
 */
@RestController
@RequestMapping("/entryLikeCollect")
public class EntryLikeCollectController {

    @Autowired
    private EntryLikeCollectService entryLikeCollectService;
    ...
    public Model updateLikeState(@RequestBody Map<String, Object> data) throws AppException {
        ...
        boolean result = entryLikeCollectService.updateLikeState(foodEntryId, userId, likeState);
    ...
    public Model updateCollectState(@RequestBody Map<String, Object> data) throws AppException {
        ...
        boolean result = entryLikeCollectService.updateCollectState(foodEntryId, userId, collectState);
        model.addAttribute("result", result);
        return model;
    }
}
